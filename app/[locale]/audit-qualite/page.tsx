...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: isEn
      ? 'On-site hotel audit covering all key operational areas. Clear gap analysis by department and a prioritised improvement roadmap for management. Available on-property.'
      : "Audit hôtelier sur site. Analyse des écarts opérationnels par département et feuille de route priorisée pour la direction. Demandez un devis.",
    alternates: {
