...
const URLS = [
  ...
  `${SITE_URL}/en/training`,
  `${SITE_URL}/fr/formation`,
  `${SITE_URL}/en/formation-equipe-hoteliere`,
  `${SITE_URL}/fr/formation-equipe-hoteliere`,
  `${SITE_URL}/en/formation-reception-hotel`,
  `${SITE_URL}/fr/formation-reception-hotel`,
  `${SITE_URL}/en/formation-housekeeping-hotel`,
  `${SITE_URL}/fr/formation-housekeeping-hotel`,
  `${SITE_URL}/en/formation-fb-restaurant`,
  `${SITE_URL}/fr/formation-fb-restaurant`,
  `${SITE_URL}/en/formation-pre-ouverture`,
  `${SITE_URL}/fr/formation-pre-ouverture`,
  `${SITE_URL}/en/formation-chefs-de-service`,
  `${SITE_URL}/fr/formation-chefs-de-service`,
  `${SITE_URL}/en/about`,
  `${SITE_URL}/fr/about`,
  `${SITE_URL}/en/blog`,
  `${SITE_URL}/fr/blog`,
  ...
  `${SITE_URL}/en/hotel-front-office-checklist`,
  `${SITE_URL}/fr/hotel-front-office-checklist`,
  `${SITE_URL}/en/hotel-night-audit-checklist`,
  `${SITE_URL}/fr/hotel-night-audit-checklist`,
  ...
  `${SITE_URL}/en/blog/hotel-room-attendant-checklist`,
  `${SITE_URL}/fr/blog/hotel-room-attendant-checklist`,
  `${SITE_URL}/en/blog/hotel-room-cleaning-checklist`,
  `${SITE_URL}/fr/blog/hotel-room-cleaning-checklist`,
  `${SITE_URL}/en/blog/hotel-housekeeping-supervisor-checklist`,
  `${SITE_URL}/fr/blog/hotel-housekeeping-supervisor-checklist`,
  `${SITE_URL}/en/blog/hotel-bathroom-cleaning-sop`,
  `${SITE_URL}/fr/blog/hotel-bathroom-cleaning-sop`,
