 ...
 * Paths are relative to the Supabase Storage bucket "Playbook".
 * Full URL = SUPABASE_URL/storage/v1/object/public/Playbook/{path}
 *
 * Source of truth: Google Drive/_upload/{playbook}/{format}/{locale}/
 */
